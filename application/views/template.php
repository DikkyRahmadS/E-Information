    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">E - INFORMATION</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Information TV SainTek UIN</div>
                    <div class="email">saintekuin.ac.id</div>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                    <a href="<?=base_url('index.php/gambar')?>">
                    <i class = "material-icons">collections</i>
                    <span>Gambar Slideshow</span>
                    </a>
                    </li>
                    ...
                    <span>Informasi Terbaru Sidebar</span>
                    </a>
                    </li>

                    <li class="active">
                    <a href="<?=base_url('index.php/text')?>">
                    <i class = "material-icons">dehaze</i>
                    <span>Teks Berjalan Footer</span>
                    </a>
